...
export const companies: Company[] = [
  {
    ...
    benefit: "Your HQ designed and constructed in-house, to Nedbank's exact brief.",
    category: "build",
    personas: ["coo", "cfo"],
  ...
  },
  {
    ...
    benefit: "One in-house team running your building day-to-day — not a contractor chain.",
    category: "run",
    personas: ["coo"],
  ...
  },
  {
    ...
    benefit: "Precinct services run end-to-end, so business continuity is engineered in.",
    category: "run",
    personas: ["coo"],
  ...
  },
  {
    id: "blume",
    name: "Blume Energy",
    does: "Funded solar generation",
    benefit: "No-capex solar powering your floors and softening load-shedding risk.",
    category: "power",
    personas: ["cfo", "esg"],
  ...
  },
  {
    ...
    benefit: "30MW+ of developed generation standing behind your building.",
    category: "power",
    personas: ["esg", "cfo"],
  ...
  },
  {
    ...
    benefit: "Globally-deployed security tech setting the standard for the precinct.",
    category: "secure",
    personas: ["esg", "coo"],
  ...
  },
  {
    id: "valgro",
    name: "Valgro",
    does: "Agribusiness & alt-revenue",
    benefit: "Alternative revenue and on-site food production that offset occupancy cost.",
    category: "invest",
    personas: ["cfo"],
    icon: i("M12 21c0-6 3-9 8-10-1 6-4 9-8 10zM12 21c0-6-3-9-8-10 1 6 4 9 8 10zM12 11v10"),
  },
  {
    id: "oilgro",
    name: "Oilgro",
  ...
  },
  {
    ...
    benefit: "136 residences so your people can live where they work.",
    category: "live",
    personas: ["brand", "esg"],
  ...
  {
    id: "fund",
    name: "Abcon Property Fund",
    does: "Co-invests & holds",
    benefit: "A landlord with skin in the game for the full lease term — not a flip.",
    category: "invest",
    personas: ["cfo"],
  ...
  },
  {
    id: "safika",
    name: "Safika",
    does: "Investment partner",
    benefit: "Co-investment partner alongside Nedbank in the POD Property Fund.",
    category: "invest",
    personas: ["cfo"],
...
/** Companies that orbit the building in the ecosystem map. */
export const orbitCompanies = companies.filter((c) => c.id !== "fund" && c.id !== "safika");

...
export const leaseCost = {
  ...
  punch: "A fully-run, resilient building five minutes away, with power and water that stay on, no capex, and a phased move that never stops the bank. It can cost less across the lease than a major refurbishment. And it's greener, too.",
};
